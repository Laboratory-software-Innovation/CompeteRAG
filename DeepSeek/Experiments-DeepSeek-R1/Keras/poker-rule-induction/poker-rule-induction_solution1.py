...
# --- ADDED: Start timer and capture training history ---
...
# --- ADDED: Save training results to a JSON file ---
...
test_data = pd.read_csv('test/poker-rule-induction/poker-rule-induction/test.csv.zip').values
...
Traceback (most recent call last):
  File "/app/test/poker-rule-induction/poker-rule-induction_solution.py", line 79, in <module>
    X_test = scaler.transform(test_data)
