...
test_inputs = np.hstack([test_num] + [x.astype(np.float32) for x in test_cat])
...
if history and history.history:
    ...
    results = {
    "training_rmse": history.history['rmse'][last_epoch],
    "training_loss": history.history['loss'][last_epoch],
    "validation_rmse": history.history['val_rmse'][last_epoch],
