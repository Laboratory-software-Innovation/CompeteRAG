...
# Prepare input data and process test data (remaining code remains unchanged)
...
Traceback (most recent call last):
  File "/app/test/playground-series-s5e2/playground-series-s5e2_fixed.py", line 167, in <module>
    preds = model.predict(test_cat_list + [test_num_data])
  ...
  File "/usr/local/lib/python3.10/dist-packages/keras/src/layers/input_spec.py", line 160, in assert_input_compatibility
    raise ValueError(
ValueError: Layer "functional" expects 1 input(s), but it received 8 input tensors. Inputs received: [<tf.Tensor 'data:0' shape=(32,) dtype=int64>, <tf.Tensor 'data_1:0' shape=(32,) dtype=int64>, <tf.Tensor 'data_2:0' shape=(32,) dtype=int64>, <tf.Tensor 'data_3:0' shape=(32,) dtype=int64>, <tf.Tensor 'data_4:0' shape=(32,) dtype=int64>, <tf.Tensor 'data_5:0' shape=(32,) dtype=int64>, <tf.Tensor 'data_6:0' shape=(32,) dtype=int64>, <tf.Tensor 'data_7:0' shape=(32, 2) dtype=float32>]
</Error>
