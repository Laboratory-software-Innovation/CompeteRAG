...
num_features = ['Age', 'Work Pressure', 'Job Satisfaction', 
                'Work/Study Hours', 'Financial Stress']  # Fixed column name
...
Traceback (most recent call last):
  File "/app/test/playground-series-s4e11/playground-series-s4e11_fixed.py", line 111, in <module>
    tuner.search(
  File "/usr/local/lib/python3.10/dist-packages/keras_tuner/src/engine/base_tuner.py", line 235, in search
    self.on_trial_end(trial)
  File "/usr/local/lib/python3.10/dist-packages/keras_tuner/src/engine/base_tuner.py", line 339, in on_trial_end
    self.oracle.end_trial(trial)
  File "/usr/local/lib/python3.10/dist-packages/keras_tuner/src/engine/oracle.py", line 108, in wrapped_func
    ret_val = func(*args, **kwargs)
  File "/usr/local/lib/python3.10/dist-packages/keras_tuner/src/engine/oracle.py", line 588, in end_trial
    self._check_consecutive_failures()
  File "/usr/local/lib/python3.10/dist-packages/keras_tuner/src/engine/oracle.py", line 545, in _check_consecutive_failures
    raise RuntimeError(
