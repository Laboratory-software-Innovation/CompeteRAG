...
from tensorflow.keras.layers import Input, Conv2D, Dense, BatchNormalization, concatenate, Reshape, UpSampling2D, Concatenate
...
# Convert test data to flattened format
...
Traceback (most recent call last):
  File "/app/test/conway-s-reverse-game-of-life/conway-s-reverse-game-of-life_kt_solution.py", line 74, in <module>
    tuner = kt.BayesianOptimization(
  ...
  File "/app/test/conway-s-reverse-game-of-life/conway-s-reverse-game-of-life_kt_solution.py", line 63, in build
    x = dropout(drop)(x)
TypeError: dropout(): argument 'input' (position 1) must be Tensor, not float
</Error>